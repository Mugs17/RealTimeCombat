...
void APlayerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// PlayerAttack
	PlayerInputComponent->BindAction("AttackSlot_1", EInputEvent::IE_Pressed, this, &APlayerCharacter::SetAttackSlot_1);
	PlayerInputComponent->BindAction("AttackSlot_2", EInputEvent::IE_Pressed, this, &APlayerCharacter::SetAttackSlot_2);
